	...
	<body>
		...
		<a href="http://localhost/QRCSystem/">Back </a>
			...
			while($row = mysqli_fetch_assoc($result)){
				...
				$datasaya .= "<tr><td>" . $row["id_matrik"] . "</td><td>" . $row["fullname"] . "</td><td>" .$row["department"]. "</td>
				<td>" .$row["level"]. "</td><td>" .$row["branch"]. "</td><td><img src='../praktisqr2/imageqr/" .$row["id_matrik"]. ".png' width='100px'></td>
				</tr>";
