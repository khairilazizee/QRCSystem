	...
	<body>
		...
		if(isset($_GET["cek"])){
			...
			while($row = mysqli_fetch_assoc($result)){
				...
				$datasaya .= "<tr><td>" . $row["id_matrik"] . "</td><td>" . $row["fullname"] . "</td><td>" .$row["department"]. "</td><td>" .$row["level"]. "</td><td>" .$row["branch"]. "</td><td><img src='qr/" .$row["id_matrik"]. ".png' width='64px'></td></tr>";
